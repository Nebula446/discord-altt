...
//GENEL KOMUTU
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=BOTUNİDSİ&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/TfvmeUhQ)`  + "** | **" + `[Oy Ver](https://discord.gg/TfvmeUhQ)`  + "** | **" + `[Web Sitesi](https://discord.gg/TfvmeUhQ)  `, false)
...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](https://discord.gg/TfvmeUhQ)** 
  **[${prefix}yardım Eğlence](https://discord.gg/TfvmeUhQ)**
  **[${prefix}yardım Moderasyon](https://discord.gg/TfvmeUhQ)**
  **[${prefix}yardım Sunucu](https://discord.gg/TfvmeUhQ)**
  **[${prefix}yardım Sahip](https://discord.gg/TfvmeUhQ)**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=BOTUNİDSİ&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/TfvmeUhQ)`  + "** | **" + `[Oy Ver](https://discord.gg/TfvmeUhQ)`  + "** | **" + `[Web Sitesi](https://discord.gg/TfvmeUhQ)  `, false)
